<?php
/**
 * Uninstall cleanup for BetterBuilds Forms for HubSpot.
 *
...
global $wpdb;
$bbhubspot_forms_like         = $wpdb->esc_like( '_transient_bb-forms-for-hubspot_' ) . '%';
$bbhubspot_forms_timeout_like = $wpdb->esc_like( '_transient_timeout_bb-forms-for-hubspot_' ) . '%';
